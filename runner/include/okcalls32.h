//c & c++
int LANG_CV[] = {3,4,8,11,33,45,85,122,140,146,192,197,243,252,272,SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
		SYS_close, SYS_access, SYS_brk, SYS_munmap, SYS_mprotect,
		SYS_mmap2, SYS_fstat64, SYS_set_thread_area, 463, 0 };
//pascal
int LANG_PV[] = { 0,9, 59, 97, 13, 16, 89, 140, 91, 175, 195, 13, SYS_open, SYS_set_thread_area,
		SYS_brk, SYS_read, SYS_uname, SYS_write, SYS_execve, SYS_ioctl,
		SYS_readlink, SYS_mmap, SYS_rt_sigaction, SYS_getrlimit, 252, 191, 0 };
//java
int LANG_JV[] = { 3,6,11,20,33,45,85,91,120,122,125,172,174,175,191,192,195,197,240,243,252,258,295,311
		...
		SYS_exit_group, 0 };
//ruby
int LANG_RV[] = { 3,4,5,6,11,33,42,45,54,77,78,91,120,122,125,174,175,183,186,191,192,
...
//bash
int LANG_BV[] = { 3,4,5,6,11,20,33,45,54,63,64,65,78,116,122,125,140,174,175,183,191,192,195,197,199,200,201,202,221,243,252,
...
//python
int LANG_YV[]={3,4,5,6,11,33,45,54,85,116,122,125,140,174,175,183,
		191,192,195,196,197,199,200,201,202,220,243,252,258,
		311,13,41,91,102,186,221,240,295,0};
//php
int LANG_PHV[] = {3,4,5,6,11,13,33,45,54,78,91,122,125,140,174,175,183,191,192,195,
...
//perl
int LANG_PLV[] = { 78, 158, 117, 60, 39, 102, 191, SYS_access, SYS_brk,
...
//c-sharp
int LANG_CSV[] = {3,4,5,6,11,13,33,45,54,78,85,91,99,102,120,122,125,140,141,158,174,175,
...
//objective-c
int LANG_OV[] = {3,221,102, 191, SYS_access, SYS_brk, SYS_close, SYS_execve,
		...
		SYS_write, 0 };
//freebasic
int LANG_BASICV[] = {3,4,5,6,11,33,45,54,91,101,122,125,140,174,175,191,192,195,197,240,243,252,258,311,330
...
//scheme
int LANG_SV[] = { 100, 295, SYS_fcntl64, SYS_getdents64, SYS_ugetrlimit,
		SYS_rt_sigprocmask, SYS_futex, SYS_read, SYS_mmap2, SYS_stat64,
		SYS_open, SYS_close, SYS_execve, SYS_access, SYS_brk, SYS_readlink,
		SYS_munmap, SYS_close, SYS_uname, SYS_clone, SYS_uname, SYS_mprotect,
		SYS_rt_sigaction, SYS_sigprocmask, SYS_getrlimit, SYS_fstat64,
		...
		SYS_exit_group, 0 };
//lua
int LANG_LUAV[]={3,4,5,6,11,13,33,45,91,125,174,192,195,197,243,252,330,0};
//nodejs
int LANG_JSV[]={3,4,5,6,11,33,45,54,75,78,85,91,120,122,125,168,174,175,183,191,192,195,196,197,199,200,201,202,224,240,243,252,255,256,258,265,266,311,328,329,331,0};
//go-lang
int LANG_GOV[]={3,4,11,120,123,174,175,186,192,240,242,252,265,0};

//sqlite3
int LANG_SQLV[]={3,4,5,6,11,33,45,54,102,122,125,140,174,175,183,191,192,195,197,199,221,240,243,252,258,311,0};
//fortran
int LANG_FV[]={3,4,11,33,45,85,122,174,197,243,252,0};
//matlab
int LANG_MV[]={3,4,6,11,20,33,45,54,78,85,91,102,122,125,140,146,168,174,175,183,191,192,195,196,197,199,220,221,240,242,243,252,258,295,311,355,0};
